...
import time
import datetime
from autoLIFEncoder import AutoLIFEncoder
from helpers import *
...
auto_encoder = AutoLIFEncoder(model, n_filter_width, n_filters)
...
with tf.Session() as sess:
    ...
    x_raw = x_rawz[start:start + n_steps + n_filter_width]
    ...
    for t in range(model.n_runs):
        ...
        plotter.update_plot_x(x_hat_vals[0,:,:], analysis_vals, synthesis_vals, w_vals[0,:,:],
                                v_vals[0,:,:], a_vals[0,:,:])
        time.sleep(0.1)
